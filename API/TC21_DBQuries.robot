...
#Suite Setup       Connect To Database    psycopg2    merchant_onboarding_Test    SVC_merchant_onboarding_Tes    d6a35858d61d85e4a82ab1fb044aba9d23451    192.168.104.11    5454
...
*** Variables ***
${DBHost}         192.168.104.113
${DBName}         merchant_onboarding_Test
${DBPass}         d6a35858d61d85e4a82ab1fb044aba9d23451
${DBPort}         5454
${DBUser}         SVC_merchant_onboarding_Test

*** Test Cases ***

update Data Into Table foobar
    [Tags]    WBMDB01
    ${output} =    Execute SQL String    update merchant_onboarding.account set lmsmerchantid=103 where id=10;
    Log    ${output}
    Should Be Equal As Strings    ${output}    None

Insert Data Into Table foobar
    [Tags]    WBMDB02
    ${output} =    Execute SQL String    insert into public.person_toBedeleted values(5,'abdul','ahmed')
    Log    ${output}
    Should Be Equal As Strings    ${output}    None
